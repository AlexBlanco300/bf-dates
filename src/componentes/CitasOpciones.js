        ...
        case cita === '1':
            return (
                <div className="divCita1 animate__animated animate__bounceInUp animate__faster">
                    ...
                    <div>
                        <img src="././piper.jpg" width="60%" className="imgCita" alt="imagen de Date"/>
                    </div>
                </div>
            )
        ...
        case cita === '2':
            return (
                <div className="divCita2 animate__animated animate__bounceInUp animate__faster">
                    ...
                    <img src="../smart.jpg" width="80%" className="imgCita" alt="imagen de Date"/>
                </div>
            )
        ...
        case cita === '3':
            return (
                <div className="divCita3 animate__animated animate__bounceInUp animate__faster">
                    ...
                    <img src="./papas.jpg" width="80%" className="imgCita" alt="imagen de Date"/>
                </div>
            )
